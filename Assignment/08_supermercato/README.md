...
## Comandi di versionamneto
```bash
git add --all
git commit "Versione 1 del programma di simulazione del supermercato"
...
- espandere il supermarcato con funzionalità extra come prezzi
- riepliogo dettaglio del carrello: visulazza quantita, prezzo unitarlo e totale per ogni prodotto
...
```bash
git add --all
git commit "Versione 2 del programma di simulazione del supermercato"
git push -u origin main
```
