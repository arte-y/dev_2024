...
do
{
    ...
    string nomeUtente = ChiediNomeUtente();
...
#region Funzioni
// Funzione per stampare i tentativi degli utenti
void StampaTentativiUtenti(Dictionary<string, List<int>> tentativiUtenti)
{
    Console.WriteLine("Tentativi effettuati: ");
...
// Funzione per chiedere il nome dell'utente
...
// Funzione per chiedere il livello di difficolta'
int ChiediLivelloDifficolta()
{
    int scelta = 0;
...
// Funzione per chiedere il tentativo all'utente
int ChiediTentativo()
{
    int numeroUtente = 0;
...
// Funzione per stampare il punteggio dell'utente
void StampaPunteggio(int punteggio)
{
    Console.WriteLine($"Punteggio: {punteggio}");
}

// Funzione per stampare il messaggio di fine partita
void StampaFinePartita(int numeroDaIndovinare)
{
    Console.WriteLine($"Hai esaurito i tentativi. Il numero era {numeroDaIndovinare}.");
}
